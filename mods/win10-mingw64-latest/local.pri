...
##  CONFIG      += console
  ...
  ULOC        = /mingw64
  QWT3D       = ../qwtplot3d
  QTPATH      = /home/e/src/qt-5.15.7
  QWTPATH     = /home/e/src/qt-5.15.7-qwt-6.1.6
  MINGWDIR    = /mingw64/x86_64-w64-mingw32
...
#  SINGLEDIR   = $$QTPATH/addons/qtsingleapplication-2.6_1-opensource/src/
  INCLUDEPATH += $$QWTPATH/src /mingw64/include/mysql
  ...
  contains( DEBUGORRELEASE, debug ) {
    ...
    MYSQLLIB    = /mingw64/lib/libmysqlclient.dll.a
  }
